...
\restrict TTzjYmPxebaKqsKbqfuvBJ84UfwqSddEBPihQMVCHobRN2g4tXYwMrs80DQpqbg
...
CREATE TABLE public."03医院_项目表" (
    ...
    "S04_Start_医院立项资料输出与递交_开始时间" date,
    "S04_Progress_医院立项资料输出与递交_当前进度" integer DEFAULT 0,
    "S04_Plan_医院立项资料输出与递交_计划完成时间" date,
    "S04_Act_医院立项资料输出与递交_实际完成时间" date,
    "S04_Note_医院立项资料输出与递交_备注信息" text,
    "S05_Start_伦理审批与启动会_开始时间" date,
    "S05_Progress_伦理审批与启动会_当前进度" integer DEFAULT 0,
    "S05_Plan_伦理审批与启动会_计划完成时间" date,
    "S05_Act_伦理审批与启动会_实际完成时间" date,
    "S05_Note_伦理审批与启动会_备注信息" text,
    "S06_Start_人员与物资准备_开始时间" date,
    "S06_Progress_人员与物资准备_当前进度" integer DEFAULT 0,
    "S06_Plan_人员与物资准备_计划完成时间" date,
    "S06_Act_人员与物资准备_实际完成时间" date,
    "S06_Note_人员与物资准备_备注信息" text,
    "S07_Start_试验开展与数据汇总表管理_开始时间" date,
    "S07_Progress_试验开展与数据汇总表管理_当前进度" integer DEFAULT 0,
    "S07_Plan_试验开展与数据汇总表管理_计划完成时" date,
    "S07_Act_试验开展与数据汇总表管理_实际完成时间" date,
    "S07_Note_试验开展与数据汇总表管理_备注信息" text,
    "S08_Start_小结输出与定稿_开始时间" date,
    "S08_Progress_小结输出与定稿_当前进度" integer DEFAULT 0,
    "S08_Plan_小结输出与定稿_计划完成时间" date,
    "S08_Act_小结输出与定稿_实际完成时间" date,
    "S08_Note_小结输出与定稿_备注信息" text,
    "里程碑" json,
    "S04_Contributors_医院立项资料输出与递交_进度贡献" json,
    "S05_Contributors_伦理审批与启动会_进度贡献者" json,
    "S06_Contributors_人员与物资准备_进度贡献者" json,
    "S07_Contributors_试验开展与数据汇总表管理_进度贡" json,
    "S08_Contributors_小结输出与定稿_进度贡献者" json
);
...
CREATE TABLE public."04项目总表" (
    ...
    "05人员表_id" integer,
    "重要紧急程度" text,
    "S01_Start_需求与背景调研_开始时间" date,
    "S01_Progress_需求与背景调研_当前进度" integer DEFAULT 0,
    "S01_Plan_需求与背景调研_计划完成时间" date,
    "S01_Act_需求与背景调研_实际完成时间" date,
    "S01_Note_需求与背景调研_备注信息" text,
    "S02_Start_方案设计审核_开始时间" date,
    "S02_Progress_方案设计审核_当前进度" integer DEFAULT 0,
    "S02_Plan_方案设计审核_计划完成时间" date,
    "S02_Act_方案设计审核_实际完成时间" date,
    "S02_Note_方案设计审核_备注信息" text,
    "S03_Start_医院筛选与专家对接_开始时间" date,
    "S03_Progress_医院筛选与专家对接_当前进度" integer DEFAULT 0,
    "S03_Plan_医院筛选与专家对接_计划完成时间" date,
    "S03_Act_医院筛选与专家对接_实际完成时间" date,
    "S03_Note_医院筛选与专家对接_备注信息" text,
    "S09_Start_验证试验开展与数据管理_开始时间" date,
    "S09_Progress_验证试验开展与数据管理_当前进度" integer DEFAULT 0,
    "S09_Plan_验证试验开展与数据管理_计划完成时间" date,
    "S09_Act_验证试验开展与数据管理_实际完成时间" date,
    "S09_Note_验证试验开展与数据管理_备注信息" text,
    "S09_Sample_验证试验开展与数据管理_样本来源与数" json,
    "S10_Start_总报告输出与定稿_开始时间" date,
    "S10_Progress_总报告输出与定稿_当前进度" integer DEFAULT 0,
    "S10_Plan_总报告输出与定稿_计划完成时间" date,
    "S10_Act_总报告输出与定稿_实际完成时间" date,
    "S10_Note_总报告输出与定稿_备注信息" text,
    "S11_Start_资料递交与结题归档_开始时间" date,
    "S11_Progress_资料递交与结题归档_当前进度" integer DEFAULT 0,
    "S11_Plan_资料递交与结题归档_计划完成时间" date,
    "S11_Act_资料递交与结题归档_实际完成时间" date,
    "S11_Note_资料递交与结题归档_备注信息" text,
    "S12_Start_临床试验发补与资料递交_开始时间" date,
    "S12_Progress_临床试验发补与资料递交_当前进度" integer DEFAULT 0,
    "S12_Plan_临床试验发补与资料递交_计划完成时间" date,
    "S12_Act_临床试验发补与资料递交_实际完成时间" date,
    "S12_Note_临床试验发补与资料递交_备注信息" text,
    "S13_Start_文章初稿输出_开始时间" date,
    "S13_Progress_文章初稿输出_当前进度" integer DEFAULT 0,
    "S13_Plan_文章初稿输出_计划完成时间" date,
    "S13_Act_文章初稿输出_实际完成时间" date,
    "S13_Note_文章初稿输出_备注信息" text,
    "S14_Start_文章内部审评、修改、投递_开始时间" date,
    "S14_Progress_文章内部审评、修改、投递_当前进度" integer DEFAULT 0,
    "S14_Plan_文章内部审评、修改、投递_计划完成时" date,
    "S14_Act_文章内部审评、修改、投递_实际完成时间" date,
    "S14_Note_文章内部审评、修改、投递_备注信息" text,
    "S15_Start_意见反馈与文章返修_开始时间" date,
    "S15_Progress_意见反馈与文章返修_当前进度" integer DEFAULT 0,
    "S15_Plan_意见反馈与文章返修_计划完成时间" date,
    "S15_Act_意见反馈与文章返修_实际完成时间" date,
    "S15_Note_意见反馈与文章返修_备注信息" text,
    "里程碑" json,
    "S01_Contributors_需求与背景调研_进度贡献者" json,
    "S02_Contributors_方案设计审核_进度贡献者" json,
    "S03_Contributors_医院筛选与专家对接_进度贡献者" json,
    "S09_Contributors_验证试验开展与数据管理_进度贡献" json,
    "S10_Contributors_总报告输出与定稿_进度贡献者" json,
    "S11_Contributors_资料递交与结题归档_进度贡献者" json,
    "S12_Contributors_临床试验发补与资料递交_进度贡献" json,
    "S13_Contributors_文章初稿输出_进度贡献者" json,
    "S14_Contributors_文章内部审评_修改_投递_进度贡献" json,
    "S15_Contributors_意见反馈与文章返修_进度贡献者" json
);
...
\unrestrict TTzjYmPxebaKqsKbqfuvBJ84UfwqSddEBPihQMVCHobRN2g4tXYwMrs80DQpqbg
